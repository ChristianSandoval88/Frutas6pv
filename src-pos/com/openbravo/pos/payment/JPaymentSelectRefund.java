...
public class JPaymentSelectRefund extends JPaymentSelect {
    ...
    protected void addTabs() {
        ...
        addTabPayment(new JPaymentSelect.JPaymentPaper_1RefundCreator());
        addTabPayment(new JPaymentSelect.JPaymentFreeRefundCreator());
        addTabPayment(new JPaymentSelect.JPaymentFreeRefundCreator_1());
