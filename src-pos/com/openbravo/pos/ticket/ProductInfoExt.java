...
public class ProductInfoExt {
    ...
    protected double m_dCantMayoreo;
    protected double m_dCantMedMayoreo;
    ...
    public final double getCantMayoreo() {
        return m_dCantMayoreo;
    }

    public final void setCantMayoreo(double cant) {
        m_dCantMayoreo = cant;
    }
    
    public final double getCantMedMayoreo() {
        return m_dCantMedMayoreo;
    }

    public final void setCantMedMayoreo(double cant) {
        m_dCantMedMayoreo = cant;
    }
    ...
    public static SerializerRead getSerializerRead() {
        return new SerializerRead() { public Object readValues(DataRead dr) throws BasicException {
            ...
            product.m_dCantMedMayoreo = dr.getDouble(17).doubleValue();
            product.m_dCantMayoreo = dr.getDouble(18).doubleValue();
            return product;
        }};
    }
