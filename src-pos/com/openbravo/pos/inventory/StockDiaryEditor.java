    ...
    private void assignProduct(ProductInfoExt prod) {
        ...
        if (jproduct.isEnabled()) {
            if (prod == null) {
                ...
                try {
                    double inventario = this.m_dlSales.findProductStock("0", this.productid, null);
                    this.m_jprice1.setText(String.valueOf(inventario));
                  } catch (BasicException ex) {
                    Logger.getLogger("JPanelTicket").log(Level.SEVERE, (String)null, (Throwable)ex);
                  } 
