...
public class ProductsEditor extends JPanel implements EditorRecord {
    ...
    public ProductsEditor(DataLogicSales dlSales, DirtyManager dirty) {
        ...
        m_jCantMayoreo.getDocument().addDocumentListener(dirty);
        m_jCantMedMayoreo.getDocument().addDocumentListener(dirty);
...
this.m_jCant1.getDocument().addDocumentListener(dirty);
    ...
    public void writeValueEOF() {
        ...
        m_jCantMayoreo.setText(null);
        m_jCantMedMayoreo.setText(null);
        ...
        m_jmargin2.setText(null);
        m_jmargin3.setText(null);
        m_jmargin4.setText(null);
        setPriceSell(null);         
        ...
        m_jCantMayoreo.setEnabled(false);
        ...
        m_jmargin2.setEnabled(false);
        m_jmargin3.setEnabled(false);
        m_jmargin4.setEnabled(false);
    ...
    public void writeValueInsert() {
        ...
        m_jPriceSell.setText("0");
        m_jCantMayoreo.setText("25.00");
        m_jCantMedMayoreo.setText("10.00");
        m_jPriceSell2.setText("0");
        m_jPriceSell3.setText("0");
        m_jPriceSell4.setText("0");
        m_jmargin.setText("0");
        m_jmargin2.setText("0");
        m_jmargin3.setText("0");
        m_jmargin4.setText("0");
        ...
        m_jCantMayoreo.setEnabled(true); 
        m_jCantMedMayoreo.setEnabled(true); 
        ...
        m_jmargin2.setEnabled(true);
        m_jmargin3.setEnabled(true);
        m_jmargin4.setEnabled(true);
    ...
    public void writeValueDelete(Object value) {
        ...
        m_jCantMedMayoreo.setText(Formats.CURRENCY.formatValue(myprod[20]));
        m_jCantMayoreo.setText(Formats.CURRENCY.formatValue(myprod[21]));
        ...
        m_jPriceBuy.setEnabled(false);
        m_jCantMayoreo.setEnabled(false);
        m_jCantMedMayoreo.setEnabled(false);
        m_jPriceSell.setEnabled(false);
        m_jPriceSell2.setEnabled(false);
        m_jPriceSell3.setEnabled(false);
        m_jPriceSell4.setEnabled(false);
    ...
    public void writeValueEdit(Object value) {
        ...
        attmodel.setSelectedKey(myprod[10]);
        m_jImage.setImage((BufferedImage) myprod[11]);
        m_jstockcost.setText(Formats.DOUBLE.formatValue(myprod[12]));
        m_jstockvolume.setText(Formats.DOUBLE.formatValue(myprod[13]));
        m_jInCatalog.setSelected(((Boolean)myprod[14]).booleanValue());
        m_jCatalogOrder.setText(Formats.INT.formatValue(myprod[15]));
        m_jPriceSell2.setText(Formats.CURRENCY.formatValue(myprod[17]));
        m_jPriceSell3.setText(Formats.CURRENCY.formatValue(myprod[18]));
        m_jPriceSell4.setText(Formats.CURRENCY.formatValue(myprod[19]));
        m_jCantMedMayoreo.setText(Formats.DOUBLE.formatValue(myprod[20]));
        m_jCantMayoreo.setText(Formats.DOUBLE.formatValue(myprod[21]));
        /*
        ...
        dPriceSell = readCurrency(m_jPriceSell2.getText());
        if(dPriceSell>0.00)
        {
        m_jmargin2.setText(Formats.PERCENT.formatValue(new Double(dPriceSell.doubleValue() / dPriceBuy.doubleValue() - 1.0)));
        }
        dPriceSell = readCurrency(m_jPriceSell3.getText());
        if(dPriceSell>0.00)
        {
        m_jmargin3.setText(Formats.PERCENT.formatValue(new Double(dPriceSell.doubleValue() / dPriceBuy.doubleValue() - 1.0)));
        }
        dPriceSell = readCurrency(m_jPriceSell4.getText());
        if(dPriceSell>0.00)
        {
        m_jmargin4.setText(Formats.PERCENT.formatValue(new Double(dPriceSell.doubleValue() / dPriceBuy.doubleValue() - 1.0)));
        }*/
        /*m_jmargin.setText(null);
        m_jmargin2.setText(null);
        m_jmargin3.setText(null);
   ...
   //     txtAttributes.setText(Formats.BYTEA.formatValue(myprod[16]));
    ...
    public Object createValue() throws BasicException {
        ...
        myprod[12] = Formats.DOUBLE.parseValue(m_jstockcost.getText());
        ...
        myprod[20] = Formats.DOUBLE.parseValue(m_jCantMedMayoreo.getText());
        myprod[21] = Formats.DOUBLE.parseValue(m_jCantMayoreo.getText());
    ...
    private void initComponents() {
        ...
        m_jmargin1 = new javax.swing.JTextField();
        m_jmargin = new javax.swing.JTextField();
        m_jmargin2 = new javax.swing.JTextField();
        m_jmargin3 = new javax.swing.JTextField();
        m_jmargin4 = new javax.swing.JTextField();
        ...
        m_jmargin1.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        m_jmargin.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        m_jmargin2.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        m_jmargin3.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        m_jmargin4.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        m_jPriceSell4.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        jLabel24.setText("Precio3");

        jLabel25.setText("Precio4");

        jButton30.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/unsortedList.png"))); // NOI18N
        ...
        m_jPriceSell2.setBounds(160, 70, 60, 20);

        jLabel27.setText("1/2 Mayoreo");
        jPanel1.add(jLabel27);
        jLabel27.setBounds(10, 70, 61, 14);
        ...
        m_jPriceBuy.setBounds(160, 10, 60, 20);
        ...
        m_jPriceSell.setBounds(160, 40, 60, 20);
        ...
        m_jInCatalog.setBounds(160, 130, 50, 21);
        jPanel1.add(m_jScale);
        m_jScale.setBounds(160, 190, 21, 21);

        jLabel28.setText(AppLocal.getIntString("label.prodincatalog")); // NOI18N
        jPanel1.add(jLabel28);
        jLabel28.setBounds(10, 130, 150, 14);

        m_jPriceSell3.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jPanel1.add(m_jPriceSell3);
        m_jPriceSell3.setBounds(160, 100, 60, 20);

        jLabel29.setText("Mayoreo");
        jPanel1.add(jLabel29);
        jLabel29.setBounds(10, 100, 150, 14);
        jPanel1.add(m_jCantMayoreo);
        m_jCantMayoreo.setBounds(230, 100, 59, 20);

        jLabel9.setText("Mínimo");
        jPanel1.add(jLabel9);
        jLabel9.setBounds(390, 10, 80, 14);

        m_jstockcost.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jPanel1.add(m_jstockcost);
        m_jstockcost.setBounds(470, 10, 80, 20);

        jLabel10.setText("Máximo");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(390, 40, 80, 14);

        m_jstockvolume.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jPanel1.add(m_jstockvolume);
        m_jstockvolume.setBounds(470, 40, 80, 20);
        jPanel1.add(m_jCantMedMayoreo);
        m_jCantMedMayoreo.setBounds(230, 70, 59, 20);
        ...
        jTabbedPane1.addTab("Composición", jPanel4);
...
this.prod14 = JProductFinder.showMessage(this, this.dlSales);
 ...
 this.prod20 = JProductFinder.showMessage(this, this.dlSales);
    ...
    private void jButton300ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton300ActionPerformed
        if(readCurrency(m_jPriceBuy.getText())!=null&&readCurrency(m_jPriceBuy.getText())>0.0)
        {
            if(readPercent(m_jmargin.getText())!=null&&readPercent(m_jmargin.getText())>0.0)
            {
                Double dPriceBuy = readCurrency(m_jPriceBuy.getText());
                Double dMargin = readPercent(m_jmargin.getText());  
            ...
            if(readPercent(m_jmargin2.getText())!=null&&readPercent(m_jmargin2.getText())>0.0)
            {
                Double dPriceBuy = readCurrency(m_jPriceBuy.getText());
                Double dMargin2 = readPercent(m_jmargin2.getText());  

                m_jPriceSell2.setText(Formats.CURRENCY.formatValue(new Double(dPriceBuy.doubleValue() * (1.0 + dMargin2.doubleValue()))));
            }
            if(readPercent(m_jmargin3.getText())!=null&&readPercent(m_jmargin3.getText())>0.0)
            {
                Double dPriceBuy = readCurrency(m_jPriceBuy.getText());
                Double dMargin3 = readPercent(m_jmargin3.getText());  

                m_jPriceSell3.setText(Formats.CURRENCY.formatValue(new Double(dPriceBuy.doubleValue() * (1.0 + dMargin3.doubleValue()))));
            }
            if(readPercent(m_jmargin4.getText())!=null&&readPercent(m_jmargin4.getText())>0.0)
            {
                Double dPriceBuy = readCurrency(m_jPriceBuy.getText());
                Double dMargin4 = readPercent(m_jmargin4.getText());  

                m_jPriceSell4.setText(Formats.CURRENCY.formatValue(new Double(dPriceBuy.doubleValue() * (1.0 + dMargin4.doubleValue()))));
            }
        }
        else
        {
            JOptionPane.showMessageDialog(this, "Introduzca un precio de compra");
        }
    ...
    private javax.swing.JTextField m_jCantMayoreo;
    private javax.swing.JTextField m_jCantMedMayoreo;
    ...
    private javax.swing.JTextField m_jmargin1;
    private javax.swing.JTextField m_jmargin2;
    private javax.swing.JTextField m_jmargin3;
    private javax.swing.JTextField m_jmargin4;
