...
public class JTicketsBagShared extends JTicketsBag {
    ...
    private void saveCurrentTicket() {
        ...
        if (m_sCurrentTicket != null) {
            try {
                dlReceipts.insertSharedTicket(m_sCurrentTicket, m_panelticket.getActiveTicket(), m_App.getInventoryLocation());
    ...
    private void selectValidTicket() {
        ...
        try {
            List<SharedTicketInfo> l = dlReceipts.getSharedTicketList(m_App.getInventoryLocation());
            if (l.size() == 0) {
                newTicket();
            } else {
