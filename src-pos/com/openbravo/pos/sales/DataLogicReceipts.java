...
public class DataLogicReceipts extends BeanFactoryDataSingle {
    ...
    public final List<SharedTicketInfo> getSharedTicketList(String location) throws BasicException {
        
        return (List<SharedTicketInfo>) new StaticSentence(s
                , "SELECT ID, NAME FROM SHAREDTICKETS WHERE LOCATION='"+location+"' ORDER BY ID"
                , null
    ...
    public final void insertSharedTicket(final String id, final TicketInfo ticket, final String location) throws BasicException {
        
        Object[] values = new Object[] {id, ticket.getName(), ticket, location};
        Datas[] datas = new Datas[] {Datas.STRING, Datas.STRING, Datas.SERIALIZABLE, Datas.STRING};
        
        new PreparedSentence(s
            , "INSERT INTO SHAREDTICKETS (ID, NAME,CONTENT, LOCATION) VALUES (?, ?, ?, ?)"
