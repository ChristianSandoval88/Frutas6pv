...
public class JTicketsBagTicket extends JTicketsBag {
    ...
    private void initComponents() {
        ...
        m_jPrint1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/fileopen.png"))); // NOI18N
        ...
        m_jButtons.setPreferredSize(new java.awt.Dimension(650, 46));
        ...
        m_jTicketId.setPreferredSize(new java.awt.Dimension(130, 25));
    ...
    private void m_jRefundActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jRefundActionPerformed
        ...
        try {
            isEdited = m_dlSales.isTicketEdited(m_ticket.getId());
        }catch (BasicException e) {}
        if(isEdited)
        {
            JOptionPane.showMessageDialog(null, "Este ticket ya tiene una devolución, tome sus precauciones", "Devolución", JOptionPane.ERROR_MESSAGE );
        }
        ...
        m_panelticketedit.setActiveTicket(refundticket, null, m_ticket);      
