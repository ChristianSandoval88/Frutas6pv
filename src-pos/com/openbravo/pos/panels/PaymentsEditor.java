...
public class PaymentsEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    public void writeValueEdit(Object value) {
        ...
        try{
            if(dlsystem.isPaymentValid(m_sId))
            {
                ...
                printTicket("Printer.Foo", this.jTotal.getText(), reason.m_sText, this.jNotes.getText(), this.m_App.getAppUserView().getUser().getName(), config.getProperty("machine.hostname"));
            }
            else
            {
    ...
    public Object createValue() throws BasicException {
        ...
        String snotes = "";
        this.m_sNotes = this.jNotes.getText();
