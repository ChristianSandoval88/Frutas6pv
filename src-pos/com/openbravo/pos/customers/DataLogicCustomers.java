...
public class DataLogicCustomers extends BeanFactoryDataSingle {
    ...
    public SentenceList getCustomerList(String location) {
        return new StaticSentence(s
            , new QBFBuilder("SELECT ID, TAXID, SEARCHKEY, NAME FROM CUSTOMERS WHERE " + (location.equals("0")?"": "CARD='" + location + "' AND ") + "?(QBF_FILTER) ORDER BY NAME", new String[] {"TAXID", "SEARCHKEY", "NAME"})
